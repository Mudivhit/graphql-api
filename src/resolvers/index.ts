      ...
      Query: {
        searchCities: async (
          ...
          try {
            ...
            const cities = await this.openMeteoService.searchCities(
              query.trim(),
              limit
            );
            return cities;
        ...
        getWeatherForecast: async (
          ...
          try {
            ...
            return await this.openMeteoService.getWeatherForecast(
              latitude,
              longitude,
              days
            );
        ...
        getRecommendedActivities: async (
          ...
          try {
            this.validateCoordinates(latitude, longitude);
            return await this.openMeteoService.getRecommendedActivities(
              latitude,
              longitude
            );
          } catch (error: any) {
